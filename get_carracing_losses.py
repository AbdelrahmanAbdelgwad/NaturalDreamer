#!/usr/bin/env python3
"""
Extract best and final loss values from car racing training CSV
"""
import pandas as pd
import os

# Path to the car racing training results CSV
csv_path = "/Users/maryam/Desktop/Fall2025/Deep_Learning/NaturalDreamer/Train results/CarRacing-v3_CarRacingV3-Present-1.csv"
...
print("=" * 80)
print("CAR RACING TRAINING LOSS ANALYSIS")
print("=" * 80)
print()
