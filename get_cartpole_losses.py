#!/usr/bin/env python3
"""
Extract best and final loss values from cartpole training CSV
"""
import pandas as pd
import os

# Path to the cartpole training results CSV
csv_path = "/Users/maryam/Desktop/Fall2025/Deep_Learning/NaturalDreamer/Train results/cartpole-swingup_CartpoleSwingup-1.csv"
...
print("=" * 80)
print("CARTPOLE TRAINING LOSS ANALYSIS")
print("=" * 80)
print()
